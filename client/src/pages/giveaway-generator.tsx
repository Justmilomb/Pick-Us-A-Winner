    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": { "@type": "Answer", "text": "PickUsAWinner is a free giveaway generator trusted by creators. It offers Instagram comment picking with anti-fraud detection, spin the wheel, random name picker, and scheduled giveaways. No monthly subscription — just a one-time payment (£2.50) option for premium features." }
      },
      {
        "@type": "Question",
      ...
      <div className="space-y-12">
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-lg sm:text-xl md:text-2xl font-bold text-slate-700 max-w-3xl mx-auto">
            ...
            No monthly fees — one-time payment (£2.50) for premium, free tools forever.
          </p>
