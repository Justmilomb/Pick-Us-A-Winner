...
export default function GiveawayGenerator() {
  const structuredData = {
    ...
    "description": "The best free giveaway generator for Instagram, YouTube, TikTok, and Facebook. Trusted by creators. One-time payment, no subscriptions. Pick random winners with verified fairness.",
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": { "@type": "Answer", "text": "PickUsAWinner is a free giveaway generator trusted by creators. It offers Instagram comment picking with anti-fraud detection, spin the wheel, random name picker, and scheduled giveaways. No monthly subscription — just a one-time payment option for premium features." }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": { "@type": "Answer", "text": "Yes! Basic features including the spin wheel, name picker, and option picker are 100% free. Instagram comment fetching includes free credits, with additional credits available as a one-time purchase — no recurring subscriptions." }
      },
      {
        "@type": "Question",
      ...
      <div className="space-y-12">
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-lg sm:text-xl md:text-2xl font-bold text-slate-700 max-w-3xl mx-auto">
            ...
            No monthly fees — one-time payment for premium, free tools forever.
          </p>
        ...
        <section className="border-4 border-black bg-primary text-white p-8 md:p-12 shadow-neo space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { icon: <Zap className="w-10 h-10" />, title: "No Subscriptions", desc: "Free tools forever. Instagram comment fetching uses a one-time credit system — no monthly fees, no recurring charges, no surprise bills." },
